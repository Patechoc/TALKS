...
\title{\\\vspace{1cm} Pair-Atomic Resolution-of-the-Identity}

%\subtitle{\textcolor{magenta}{My subtitle (if applicable)}}
\author{Patrick Merlot, Simen Reine, Thomas Kjaergaard and Trygve Helgaker}
%\institute[CTCC]{\\[-6mm]<my.name>@somewhere.no\\[6mm]University of Oslo\\[6mm]
\institute[CTCC]{\\[-6mm]patrick.merlot@kjemi.uio.no\\[6mm]CTCC talks\\[6mm]
